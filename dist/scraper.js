...
exports.scrapeRates = scrapeRates;
...
async function ensureBankAccountDiscount(frame) {
    try {
...
async function selectEnergyLabel(frame) {
    try {
...
async function expandTable(frame) {
    try {
...
async function extractRates(frame) {
    const rates = [];
